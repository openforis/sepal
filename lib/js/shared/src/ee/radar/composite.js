...
const toTimeScan = collection => {
    let reduced = collection
        ...
        .select(
            ['VV_min', 'VV_max', 'VV_mean', 'VV_stdDev', 'VV_median', 'VV_nat_mean', 'VV_speckle_ratio_median', 'VH_min', 'VH_max', 'VH_mean', 'VH_stdDev', 'VH_median', 'VH_nat_mean', 'VH_speckle_ratio_median', 'orbit_mode'],
            ['VV_min', 'VV_max', 'VV_mean', 'VV_std', 'VV_med', 'VV_nat_mean', 'VV_speckle_ratio', 'VH_min', 'VH_max', 'VH_mean', 'VH_std', 'VH_med', 'VH_nat_mean', 'VH_speckle_ratio', 'dominant_orbit']
        )
    ...
    return reduced
        ...
        .select([
            'VV_min', 'VV_max', 'VV_mean', 'VV_std', 'VV_med', 'VV_speckle_ratio', 'VH_min', 'VH_max', 'VH_mean', 'VH_std', 'VH_med', 'VH_speckle_ratio', 'ratio_VV_med_VH_med', 'VV_cv', 'VH_cv', 'NDCV', 'dominant_orbit'
        ])
        .float()
}
