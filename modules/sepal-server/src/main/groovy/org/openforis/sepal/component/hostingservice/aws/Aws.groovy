...
class Aws implements HostingServiceAdapter {
    ...
    final List<InstanceType> instanceTypes = [
            ...
            new InstanceType(id: 'X132xlarge', name: 'x1.32xlarge', tag: 'x128', hourlyCost: 16.006, cpuCount: 128, ramGiB: 1920),        new InstanceType(id: 'T2Small', name: 't2.small', hourlyCost: 0.025, cpuCount: 1, ramGiB: 2, idleCount: 1),
