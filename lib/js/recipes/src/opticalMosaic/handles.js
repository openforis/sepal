...
const HANDLES = [
...

    {
        ...
        valueGuidance: 'Whole-array replacement. Methods are combined inside one per-image cloud band; method count is not itself a primary speed lever. Each item declares its companion handles and moderate/aggressive profiles.',
