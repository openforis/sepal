...
const toTimeScan = collection => {
    let reduced = collection
        ...
        .select(
            ...
            ['VV_min', 'VV_max', 'VV_mean', 'VV_std', 'VV_med', 'VV_nat_mean', 'VH_min', 'VH_max', 'VH_mean', 'VH_std', 'VH_med', 'VH_nat_mean', 'dominant_orbit']
        )
    ...
    return reduced
        ...
        .select([
            'VV_min', 'VV_max', 'VV_mean', 'VV_std', 'VV_med', 'VH_min', 'VH_max', 'VH_mean', 'VH_std', 'VH_med', 'ratio_VV_med_VH_med', 'VV_cv', 'VH_cv', 'NDCV', 'dominant_orbit'
        ])
        .float()
}
