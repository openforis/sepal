...
// Grid pixel size lives in the shared recipe policy so the GUI, the task boundary and this layer all read a
// grid identically; re-exported here for the existing EE-side importers.
import {gridPixelSize} from '#sepal/recipe/samplingDesign/samplingGrid'

export {gridPixelSize}
