...
const applySepalCloudScore = (image, {sepalCloudScoreMaxCloudProbability}) => {
    const threshold = sepalCloudScoreMaxCloudProbability / 100
    return image
        .selfExpression(`
...
module.exports = applySepalCloudScore
