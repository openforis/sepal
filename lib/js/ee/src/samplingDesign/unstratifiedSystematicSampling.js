...
import {SQRT3, unstratifiedLatticeDiameter} from './systematicLatticeMath.js'
...
const unstratifiedLayout = ({allocation, sampleArrangement, densityOffset = 0}) => {
    ...
    // Analytical spacing from the projection's nominal scale and minDistance; independent of any grid transform.
    const proj = ee.Projection(sampleArrangement.arrangementGrid.crs)
