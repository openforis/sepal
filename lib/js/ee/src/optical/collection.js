...
import dataSetSpecs from '#sepal/recipe/optical/dataSetSpecs'
import {commonBands} from '#sepal/recipe/optical/opticalBands'

import {compose} from '../functional.js'
import applyPercentileFilter from './applyPercentileFilter.js'
import imageProcess from './imageProcess.js'
import preventHoles from './maaskPreventingHoles.js'
import maskShadows from './maskShadows.js'
import {prepareSentinel2Collection} from './sentinel2Collection.js'

export {allScenes, findCommonBands, hasImagery, selectedScenes}
...
function findCommonBands(dataSets, reflectance) {
    return commonBands(dataSets, reflectance)
}
