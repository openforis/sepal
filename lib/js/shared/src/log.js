...
// Silence all loggers — for CLI processes (e.g. ssh-gateway's interactive menu) whose
// stdout is a user-facing terminal that log output would corrupt.
const configureNoLogging = () =>
    log4js.configure({
        appenders: {console: {type: 'console'}},
