import {
    DEFAULT_SAMPLING_GRID_CRS,
    EASE_GRID_2_GLOBAL_WKT,
    isSupportedSamplingGridCrs,
    resolveSamplingGrid,
    resolveSamplingGridCrs,
    SAMPLING_GRID_CRS_DEFINITIONS,
    supportedSamplingGridCrsNames
} from './samplingGridCrs.js'
...
describe('resolution to Earth Engine values', () => {
    ...
    it('carries every other grid field through resolution unchanged', () => {
        expect(resolveSamplingGrid({crs: 'EPSG:6933', crsTransform: '[10,0,0,0,-10,0]', scale: undefined}))
            .toEqual({crs: EASE_GRID_2_GLOBAL_WKT, crsId: 'EPSG:6933', crsTransform: '[10,0,0,0,-10,0]', scale: undefined})
