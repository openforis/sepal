...
module.exports = {
    getCollection$: ({recipe, geometry: geo, startDate: sd, endDate: ed, bands}) => {
        ...
        const {
            includedCloudMasking, sentinel2CloudProbabilityMaxCloudProbability, sentinel2CloudScorePlusBand, sentinel2CloudScorePlusMaxCloudProbability,
        ...
        const planetImages = (classificationRecipe, trainingData) => {
            const cloudThreshold = cloudMasking === 'MODERATE' ? 1 : .25
