...
var showError = function (errorContainer, message) {
  showMessage(errorContainer, message, 'error', true)
}
...
var showMessage = function (container, message, type, autoHide) {
  ...
  if (autoHide)
    container.velocitySlideUp({delay: 2000, duration: 500})
}
...
var removeError = function (inputField) {
  if (inputField)
    inputField.closest('.form-group').removeClass('error')
}
