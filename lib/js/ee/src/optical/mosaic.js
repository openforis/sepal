...
function mosaic(recipe, selectedBands, panSharpen) {
    ...
    function getBands$() {
        return of([
            ...findCommonBands(dataSets, reflectance)
                .filter(band => !['qa', 'unixTimeDays', 'dayOfYear', 'daysFromTarget', 'targetDayCloseness'].includes(band)
                ),
...
function extractDataSets(dataSets) {
