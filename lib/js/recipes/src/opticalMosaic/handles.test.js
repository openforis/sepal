...
describe('MOSAIC.handles — required v1 catalog', () => {
    ...
    describe('handle metadata content', () => {
        ...
        describe('rich selector-item metadata (generic mechanism, MOSAIC cloudMethods fixture)', () => {
            ...
            it('warns that empty cloudMethods disables masking and cloudy requests should tighten compatible methods', () => {
                const guidance = byName('cloudMethods').valueGuidance

                expect(guidance).toMatch(/empty array|removing all methods/i)
                ...
                expect(guidance).toMatch(/preserve compatible/i)
