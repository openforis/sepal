...
class PreProcessingOptions extends React.Component {
    render() {
        return (
            <RecipeFormPanel
                ...
                <Panel.Header
                    icon='cog'
                    title={msg('process.baytsAlerts.panel.preprocess.title')}/>
                <Panel.Content>
                    <Layout>
    ...
    renderCorrectionsOptions() {
        ...
        return (
            <Form.Buttons
                label={msg('process.baytsAlerts.panel.preprocess.form.corrections.label')}
                input={corrections}
                multiple={true}
                options={[{
                    value: 'SR',
                    label: msg('process.baytsAlerts.panel.preprocess.form.corrections.surfaceReflectance.label'),
                    tooltip: msg('process.baytsAlerts.panel.preprocess.form.corrections.surfaceReflectance.tooltip')
                }, {
                    value: 'BRDF',
                    label: msg('process.baytsAlerts.panel.preprocess.form.corrections.brdf.label'),
                    tooltip: msg('process.baytsAlerts.panel.preprocess.form.corrections.brdf.tooltip')
                }]}
            />
        )
    }
    ...
    renderCloudDetectionOptions() {
        ...
        return (
            <Form.Buttons
                label={msg('process.baytsAlerts.panel.preprocess.form.cloudDetection.label')}
                input={cloudDetection}
                multiple
                options={[
                    {
                        value: 'QA',
                        label: msg('process.baytsAlerts.panel.preprocess.form.cloudDetection.qa.label'),
                        tooltip: msg('process.baytsAlerts.panel.preprocess.form.cloudDetection.qa.tooltip')
                    },
                    {
                        value: 'CLOUD_SCORE',
                        label: msg('process.baytsAlerts.panel.preprocess.form.cloudDetection.cloudScore.label'),
                        tooltip: msg('process.baytsAlerts.panel.preprocess.form.cloudDetection.cloudScore.tooltip')
                    },
                    {
                        value: 'PINO_26',
                        label: msg('process.baytsAlerts.panel.preprocess.form.cloudDetection.pino26.label'),
                        tooltip: msg('process.baytsAlerts.panel.preprocess.form.cloudDetection.pino26.tooltip'),
    ...
    renderCloudMaskingOptions() {
        ...
        return (
            <Form.Buttons
                label={msg('process.baytsAlerts.panel.preprocess.form.cloudMasking.label')}
                input={cloudMasking}
                options={[{
                    value: 'MODERATE',
                    label: msg('process.baytsAlerts.panel.preprocess.form.cloudMasking.moderate.label'),
                    tooltip: msg('process.baytsAlerts.panel.preprocess.form.cloudMasking.moderate.tooltip')
                }, {
                    value: 'AGGRESSIVE',
                    label: msg('process.baytsAlerts.panel.preprocess.form.cloudMasking.aggressive.label'),
                    tooltip: msg('process.baytsAlerts.panel.preprocess.form.cloudMasking.aggressive.tooltip')
                }]}
                type='horizontal'
                disabled={this.noProcessing()}
            />
    ...
    renderSnowMaskingOptions() {
        ...
        return (
            <Form.Buttons
                label={msg('process.baytsAlerts.panel.preprocess.form.snowMasking.label')}
                input={snowMasking}
                options={[{
                    value: 'OFF',
                    label: msg('process.baytsAlerts.panel.preprocess.form.snowMasking.off.label'),
                    tooltip: msg('process.baytsAlerts.panel.preprocess.form.snowMasking.off.tooltip')
                }, {
                    value: 'ON',
                    label: msg('process.baytsAlerts.panel.preprocess.form.snowMasking.on.label'),
                    tooltip: msg('process.baytsAlerts.panel.preprocess.form.snowMasking.on.tooltip')
                }]}
