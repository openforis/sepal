...
import {applySpatialSpeckleFilter} from './spatialSpeckleFilters.js'
...
function applySpeckleFilter({
    ...
    function applyRabasar(image, superImage) {
        ...
        var filteredSpeckleRatio = applySpatialSpeckleFilter({image: speckleRatio, bandNames, ...spatialSpeckleFilterOptions, strongScatterers: 'FILTER'})
        return superImage.multiply(filteredSpeckleRatio)
    }
    
}

export {applySpeckleFilter}
