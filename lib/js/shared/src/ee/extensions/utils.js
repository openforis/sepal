...
module.exports = ee => {
    ...
    return {setMaxRetries, setUsername, $, getAssetRoots$, listAssets$, listOperations$, getAsset$, replaceAssetProperties$, deleteAsset$, deleteAssetRecursive$, createAssetFolders$, createImageCollection$, getInfo$, getMap$, isNull, mosaic, sepal}
}
