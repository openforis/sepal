...
module.exports = {
    getCollection$: ({recipe, geometry: geo, startDate: sd, endDate: ed, bands}) => {
        ...
        const {
            ...
            kernelSize, targetKernelSize, sigma, strongScattererValues, snicSize, snicCompactness,  // Radar
        ...
        const radarImages = (classificationRecipe, trainingData) => {
            const collection = createRadarCollection({
                ...
                kernelSize, targetKernelSize, sigma, strongScattererValues, snicSize, snicCompactness, multitemporalSpeckleFilter, numberOfImages, minNumberOfImages, mask, minAngle, maxAngle, minObservations
            })
