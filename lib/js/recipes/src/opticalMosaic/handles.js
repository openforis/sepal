...
const HANDLES = [
    ...
    },
    {
        ...
        valueGuidance: 'Whole object replacement. Keys are source groups; values are arrays of dataset codes. Removing source groups/datasets is a high-tradeoff speed lever: fewer scenes, but less temporal/source coverage. Do not use for generic first-pass speed unless the user asks to reduce sources/data volume or accepts speed over coverage.',
    ...
    },
    {
        ...
        valueGuidance: 'Must be in [targetDate - 1 year + 1 day, targetDate]. Moving it later shortens the candidate season before targetDate; faster but may reduce clear observations/coverage. High-tradeoff: ask before narrowing season unless the user requested a shorter date range or accepted speed over coverage.',
    ...
    },
    {
        ...
        valueGuidance: 'Must be in [targetDate + 1 day, targetDate + 1 year]. Moving it earlier shortens the candidate season after targetDate; faster but may reduce clear observations/coverage. High-tradeoff: ask before narrowing season unless the user requested a shorter date range or accepted speed over coverage.',
