...
import {map, of, shareReplay, switchMap, zip} from 'rxjs'
...
const baytsAlerts = (
    ...
    if (visualizationType && visualizationType !== 'alerts') {
        ...
        return {
            ...
            getBands$() {
                return of(['non_forest_probability', 'change_probability', 'flag', 'flag_orbit', 'first_detection_date', 'confirmation_date'])
            },
            getGeometry$() {
                return delegate$.pipe(
