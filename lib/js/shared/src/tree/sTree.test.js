import {NODE, STree} from './sTree.js'
...
it('string path to array path - absolute path, ignore empty segments', () => {
    expect(STree.fromStringPath('/foo', true)).toEqual(['foo'])
})
...
it('string path to array path - middle empty segment, ignore empty segments', () => {
    expect(STree.fromStringPath('foo//bar', true)).toEqual(['foo', 'bar'])
})

it('string path to array path - middle empty segment', () => {
    expect(() => STree.fromStringPath('foo//bar')).toThrow()
})
...
it('string path to array path - ending empty segment', () => {
    expect(() => STree.fromStringPath('foo/bar/')).toThrow()
})

it('string path to array path - ending empty segment, ignore empty segments', () => {
    expect(STree.fromStringPath('foo/bar/', true)).toEqual(['foo', 'bar'])
})

it('string path to array path - multiple empty segments', () => {
    expect(() => STree.fromStringPath('foo///bar/baz/')).toThrow()
})

it('string path to array path - multiple empty segments, ignore empty segments', () => {
    expect(STree.fromStringPath('/foo///bar/baz/', true)).toEqual(['foo', 'bar', 'baz'])
})
