...
class _PreProcessingOptions extends React.Component {
    ...
    renderCorrectionsOptions() {
        ...
        return (
            <Form.Buttons
                label={msg('process.phenology.panel.preprocess.form.corrections.label')}
                input={corrections}
                multiple={true}
                options={[{
                    value: 'SR',
                    label: msg('process.phenology.panel.preprocess.form.corrections.surfaceReflectance.label'),
                    tooltip: msg('process.phenology.panel.preprocess.form.corrections.surfaceReflectance.tooltip')
                }, {
                    value: 'BRDF',
                    label: msg('process.phenology.panel.preprocess.form.corrections.brdf.label'),
                    tooltip: msg('process.phenology.panel.preprocess.form.corrections.brdf.tooltip')
                }]}
            />
        )
    }
    ...
    renderCloudDetectionOptions() {
        ...
        return (
            <Form.Buttons
                label={msg('process.phenology.panel.preprocess.form.cloudDetection.label')}
                input={cloudDetection}
                multiple
                options={[
                    {
                        value: 'QA',
                        label: msg('process.phenology.panel.preprocess.form.cloudDetection.qa.label'),
                        tooltip: msg('process.phenology.panel.preprocess.form.cloudDetection.qa.tooltip')
                    },
                    {
                        value: 'CLOUD_SCORE',
                        label: msg('process.phenology.panel.preprocess.form.cloudDetection.cloudScore.label'),
                        tooltip: msg('process.phenology.panel.preprocess.form.cloudDetection.cloudScore.tooltip')
                    },
                    {
                        value: 'PINO_26',
                        label: msg('process.phenology.panel.preprocess.form.cloudDetection.pino26.label'),
                        tooltip: msg('process.phenology.panel.preprocess.form.cloudDetection.pino26.tooltip'),
    ...
    renderCloudMaskingOptions() {
        ...
        return (
            <Form.Buttons
                label={msg('process.phenology.panel.preprocess.form.cloudMasking.label')}
                input={cloudMasking}
                options={[{
                    value: 'MODERATE',
                    label: msg('process.phenology.panel.preprocess.form.cloudMasking.moderate.label'),
                    tooltip: msg('process.phenology.panel.preprocess.form.cloudMasking.moderate.tooltip')
                }, {
                    value: 'AGGRESSIVE',
                    label: msg('process.phenology.panel.preprocess.form.cloudMasking.aggressive.label'),
                    tooltip: msg('process.phenology.panel.preprocess.form.cloudMasking.aggressive.tooltip')
                }]}
                type='horizontal'
            />
        )
    ...
    renderSnowMaskingOptions() {
        ...
        return (
            <Form.Buttons
                label={msg('process.phenology.panel.preprocess.form.snowMasking.label')}
                input={snowMasking}
                options={[{
                    value: 'OFF',
                    label: msg('process.phenology.panel.preprocess.form.snowMasking.off.label'),
                    tooltip: msg('process.phenology.panel.preprocess.form.snowMasking.off.tooltip')
                }, {
                    value: 'ON',
                    label: msg('process.phenology.panel.preprocess.form.snowMasking.on.label'),
                    tooltip: msg('process.phenology.panel.preprocess.form.snowMasking.on.tooltip')
                }]}
