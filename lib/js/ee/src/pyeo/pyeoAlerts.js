...
const pyeoAlerts = (recipe, {selection = []} = {}) => {
        ...
        return forkJoin({
            ...
            switchMap(({classificationRecipe, classificationInputs: {eeBaselineGateIndex, classifierBands}}) =>
                forkJoin({
                    ...
                    monitoringCollection: monitoringCollection$(classifierBands)
                }).pipe(
                    map(({trainingData, eeClassificationImage, monitoringCollection}) =>
                        toChangeReport({
                            classificationRecipe, trainingData, eeClassificationImage,
    ...
    const monitoringCollection$ = classifierBands =>
        getCollection$({
            recipe: {model: {
                ...model,
    ...
    const toChangeReport = ({classificationRecipe, trainingData, eeClassificationImage, eeBaselineGateIndex, monitoringCollection}) => {
