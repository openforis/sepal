...
module.exports = {
    getCollection$: ({recipe, geometry: geo, startDate: sd, endDate: ed, bands}) => {
        ...
        const {
            ...
            kernelSize, targetKernelSize, sigma, strongScattererValues, multitemporalSpeckleFilter, numberOfImages, minNumberOfImages, mask, minAngle, maxAngle, minObservations, // Radar
            histogramMatching
        ...
        const radarImages = (classificationRecipe, trainingData) => {
            const collection = createRadarCollection({
                ...
                kernelSize, targetKernelSize, sigma, strongScattererValues, multitemporalSpeckleFilter, numberOfImages, minNumberOfImages, mask, minAngle, maxAngle, minObservations
            })
