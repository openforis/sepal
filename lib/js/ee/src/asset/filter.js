...
import {propertyEqualityFilter, propertyInListFilter} from '#sepal/ee/propertyFilter'
...
const strategies = {
    ...
    '=': ({property, value}) => propertyEqualityFilter(property, value),
    'class': ({property, selectedClasses}) => propertyInListFilter(property, selectedClasses),
...
export {createFilter, propertyEqualityFilter as equalityFilter}
