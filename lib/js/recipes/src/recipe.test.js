...
describe('recipe registry', () => {
    ...
    it('returns null for an unknown recipe id', () => {
        ...
        expect(getRecipePromptFacts('UNKNOWN')).toBeNull()
    })

    it('getRecipePromptFacts delegates to the spec for a known id', () => {
        const facts = getRecipePromptFacts('MOSAIC')

        expect(facts).toEqual(getRecipeSpec('MOSAIC').promptFacts())
    })
...
describe('optical mosaic (MOSAIC) spec', () => {
    ...
    it('exposes the documented spec API', () => {
        ...
        expect(typeof spec.promptFacts).toBe('function')
