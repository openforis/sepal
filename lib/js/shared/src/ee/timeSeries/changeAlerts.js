...
function analyzeChanges(args) {
    ...
    var segments = segmentsImage.select(['tStart', 'tEnd', band + '_rmse', band + '_coefs'])
    ...
    var changesAndMasked = toArrayPerBand(collection
        ...
        .map(function(image) {
            ...
            var slice = sliceSegments(segmentsImage, dateYearAgo, dateFormat)
                ...
                // Resampling cause image problems when using an CCDC image collection asset. 
