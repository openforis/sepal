...
describe('declaration contract', () => {
    ...
    it('preserves through an ordinary identity transform, with no marker to interpret', () => {
        ...
        expect(declaration).toEqual(oneInputTransformation({role: 'image', transform: declaration.transform}))
