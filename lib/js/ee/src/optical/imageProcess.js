...
function imageProcess({
    bands, dataSetSpec, calibrate, brdfCorrect, brdfMultiplier, includedCloudMasking,
    ...
    sepalCloudScoreMaxCloudProbability, holes,
    cloudBuffer, reflectance, snowMasking, orbitOverlap, tileOverlap, panSharpen, targetDate
}) {
...
function normalize(dataSetSpec) {
    return image => {
...
function calibrateBands(dataSetSpec) {
    return image => {
