...
const main = async () => {
    ...
    program.command('build')
        ...
        .option('-p, --production', 'Build production stack (skip dev override), only for modules with allowProductionMode')
    ...
    program.command('buildrestart')
        ...
        .option('-p, --production', 'Run production stack, when supported by the module')
