const {concat, defer, map, of, switchMap, toArray} = require('rxjs')
...
module.exports = ee => {
    ...
    return {setMaxRetries, setUsername, $, getAssetRoots$, listAssets$, getAsset$, deleteAsset$, createAssetFolders$, createImageCollection$, getInfo$, getMap$, isNull, sepal}
}
