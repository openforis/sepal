...
import {inheritedSchemaRole} from '#sepal/recipe/output/transformation'
...
describe('the registered CCDC_SLICE output declaration', () => {
    it('transforms its literal PRIMARY_IMAGE role', () => {
        expect(declaration()).toEqual(expect.objectContaining({kind: 'ONE_INPUT', role: 'PRIMARY_IMAGE'}))
    })
