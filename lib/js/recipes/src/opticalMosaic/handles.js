...
const HANDLES = [
    ...
    },
    {
        ...
        valueGuidance: 'Whole-array replacement. Combine SR (surface reflectance), BRDF (view-angle correction), CALIBRATE (cross-sensor calibration). SR and CALIBRATE are mutually exclusive; SR or CALIBRATE is required when both Landsat and Sentinel-2 source groups are selected.',
