...
const correct = (image, dataSetName, maxZenith) => {
    const {viewAz, viewZen} = getViewAngles(image, dataSetName, maxZenith)
...
const getViewAngles = (image, dataSetName, maxZenith) => {
    return dataSetName === 'SENTINEL_2'
        ? getSentinel2ViewAngles(image)
        : getLandsatViewAngles(image, maxZenith)
}
