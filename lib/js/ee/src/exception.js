...
// Stable, machine-readable classification for EE failures. Unlike `name` (which embeds the operation id
// and is not stable), this lets clients branch on the error kind without parsing text.
...
class EEException extends ServerException {
    constructor(message, {cause, userMessage, errorCode, statusCode, operationId} = {}) {
        ...
        this.errorType = EARTH_ENGINE_ERROR_TYPE
...
export {createEEException, EARTH_ENGINE_ERROR_TYPE, EEException, encodeError}
