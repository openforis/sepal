...
// Which Planet collection is configured, as planetImages reads it: the first selected data set. Meaningful
// only where collectionType answers PLANET.
export const planetSource = dataSets => Object.values(dataSets || {}).flat()[0]
