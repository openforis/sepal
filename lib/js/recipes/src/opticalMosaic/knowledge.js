...
const FACTS = [
    ...
    },
    {
        ...
        guidance: [
            ...
            'Sentinel-2 Cloud Score+ is the preferred Sentinel-2 method for generic cloud-improvement requests; Sentinel-2 Cloud Probability is a legacy option.',
            'Sentinel-2 Cloud Probability and Cloud Score+ link ancillary collections when enabled.',
    ...
    },
    {
        ...
        guidance: [
            ...
            'Do not add Sentinel-2 Cloud Probability for generic residual-cloud requests; prefer Cloud Score+ unless Cloud Probability is already active or explicitly requested.',
    ...
    },
    {
        ...
        guidance: [
            ...
            'Lower cloudPercentageThreshold mostly reduces the candidate pool before per-pixel masking; it can indirectly help residual clouds when cloudy scenes have mask misses, but too low can leave no imagery.'
        ],
        tradeoffs: [
