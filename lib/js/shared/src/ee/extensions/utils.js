const {concatWith, mergeMap, catchError, concat, concatMap, defer, ignoreElements, toArray, map, merge, of, switchMap, throwError, EMPTY} = require('rxjs')
...
module.exports = ee => {
    ...
    const deleteAssetRecursive$ = (eeId, {type, include = ['Folder', 'Image', 'ImageCollection', 'Table']} = {}) =>
        type
