...
const Job = () => {
    const main = ({jobName, jobPath, schedulerName, initArgs, before, services, args, ctx}) => {
    ...
    return ({jobName, jobPath, schedulerName, initArgs, before, services, worker$, args = () => []}) => {
        ...
        return ctx => isWorker(ctx)
            ...
            : main({jobName, jobPath, schedulerName, initArgs, before, services, args, ctx})
    }
}
