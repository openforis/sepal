...
const processCollection = ({dataSets, collection, reflectance, calibrate, brdfCorrect, filters, cloudMasking, cloudBuffer, snowMasking, panSharpen, targetDate}) => {
...
module.exports = {allScenes, selectedScenes, hasImagery}
