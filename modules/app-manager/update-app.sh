...
function update_venv {
    ...
    then
        ...
        "$venv_path"/bin/python3 -m pip install --no-cache-dir "git+https://github.com/openforis/earthengine-api.git@v0.1.384#egg=earthengine-api&subdirectory=python" >> "$venv_log_file"
