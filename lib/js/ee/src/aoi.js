...
// Async wrapper over the sync toGeometry. RECIPE/ASSET AOIs are not yet supported here -
// resolving those requires imageFactory(...).getGeometry$(); see project memory.
const toGeometry$ = aoi => of(toGeometry(aoi))
