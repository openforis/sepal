...
const imageProcess = ({bands, calibrate, brdfCorrect, cloudDetection = [], cloudMasking, cloudBuffer, reflectance, snowMasking, panSharpen, targetDate}) => {
    return image =>
        compose(
            normalize(),
            applyQA(cloudDetection, cloudMasking),
            addMissingBands(),
            addIndexes(),
            addSnow(),
            addWater(),
