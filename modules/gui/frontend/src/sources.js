...
import {getDataSetOptions as radarDataSetOptions, toSources as toRadarSources} from 'app/home/body/process/recipe/radarMosaic/sources'
...
export const toSources = dataSetIds =>
    ({...toOpticalSources(dataSetIds), ...toRadarSources(dataSetIds)})
