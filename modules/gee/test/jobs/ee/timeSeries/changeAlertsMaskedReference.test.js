...
const WITNESS = join(dirname(fileURLToPath(import.meta.url)), 'changeAlertsMaskedReference.node.test.mjs')
...
it('runs the recipe that was selected as the Change Alerts reference', () => {
