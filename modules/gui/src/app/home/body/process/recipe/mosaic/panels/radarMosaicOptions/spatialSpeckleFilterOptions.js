...
const _SpatialSpeckleFilterOptions = ({
    ...
    const fields = filterFields({spatialSpeckleFilter, inputs}).map(name => ({
        label: msg(['process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions', name, 'label']),
...
class _SpatialSpeckleFilterOptionsPanel extends React.Component {
    ...
    renderKernelSize() {
        ...
        return (
            <Form.Slider
                label={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.kernelSize.label')}
                input={kernelSize}
    ...
    renderSigma() {
        ...
        return (
            <Form.Slider
                label={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.sigma.label')}
                input={sigma}
                minValue={0.5}
                maxValue={0.95}
    ...
    renderStrongScatterers() {
        ...
        const options = [
            {
                value: 'RETAIN',
                label: msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScatterers.retain.label'),
                tooltip: msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScatterers.retain.tooltip')
            },
            {
                value: 'FILTER',
                label: msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScatterers.filter.label'),
                tooltip: msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScatterers.filter.tooltip')
            }
        ]
        return (
            <Form.Buttons
                label={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScatterers.label')}
    ...
    renderStrongScattererValues() {
        ...
        return (
            <Layout type='horizontal-nowrap'>
                <Form.Input
                    label={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScattererValue1.label')}
                    tooltip={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScattererValue1.tooltip')}
                    input={strongScattererValue1}
                />
                <Form.Input
                    label={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScattererValue2.label')}
                    tooltip={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.strongScattererValue2.tooltip')}
    ...
    renderSnicOptions() {
        ...
        return (
            <Layout>
                <Form.Slider
                    label={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.snicSize.label')}
                    tooltip={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.snicSize.tooltip')}
                    input={snicSize}
                    minValue={3}
                    maxValue={15}
                    ticks={KERNEL_SIZES}
                ...
                />
                <Form.Slider
                    label={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.snicCompactness.label')}
                    tooltip={msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.snicCompactness.tooltip')}
                    ...
                    decimals={2}
                    info={value =>
                        msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.snicCompactness.value', {value})
                    }
                />
            </Layout>
        )
...
const SpatialSpeckleFilterOptionsPanel = compose(
    ...
    modalSubformPanel({
        ...
        fields,
        toTitle: () => msg('process.radarMosaic.panel.options.form.spatialSpeckleFilterOptions.title'),
