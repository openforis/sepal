...
function update_venv {
    ...
    then
        ...
        "$venv_path"/bin/python3 -m pip install "git+https://github.com/openforis/earthengine-api.git@v0.1.332#egg=earthengine-api&subdirectory=python" -U --no-cache-dir >> "$venv_log_file"
